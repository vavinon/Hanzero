        ...
        quizzes: [
          {
            ...
            encouragement: "เก่งมาก! พูดน่ารักเหมือนเจ้าแพนด้าน้อยเลย!"
          }
        ],
    ...
    lessons: [
      {
        ...
        boss_challenge: {
          scenario_th: "แพนด้าเป่าเปาเดินมาหาคุณที่ประตูเมืองฮั่นซีโร่ ยื่นมือมาจับและพูดว่า '你好！' คุณผ่านการฝึกฝนระบบเสียงมาทั้งหมด คุณจะทักทายตอบกลับอย่างไรให้ไพเราะที่สุด?",
          ...
          encouragement: "🎉 ว้าว! คุณผ่านการทดสอบต้นกล้าสำเร็จแล้ว แพนด้าเป่าเปากำลังมอบเข็มกลัดให้คุณ!"
        },
        cheer_trophy: {
