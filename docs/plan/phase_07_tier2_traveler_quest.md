...
### `TASK-705`: Core Traveler Curriculum Batch 3 & Grand Boss (Units 21–25) `DONE` ✅
- [x] **Unit 21: 文娱与观影 (Entertainment: ดูหนัง นิทรรศการ & สันทนาการ)**
...
- [x] **Unit 22: 健身与户外 (Fitness & Sports: ฟิตเนส กีฬา & กิจกรรมกลางแจ้ง)**
...
- [x] **Unit 23: 日常办公初探 (Workplace Orientation: ปฐมนิเทศออฟฟิศจีน)**
...
- [x] **Unit 24: 观点与讨论 (Opinions & Debate: แสดงความคิดเห็น & ถกเถียงสุภาพ)**
...
- [x] **Unit 25: Grand Boss: 穿越中国 (Grand Capstone: ทริปแบ็กแพ็ก 7 วัน)**
...
- [x] **เครื่องมือและสคริปต์:** สร้าง `scripts/build_tier2_batch_c.ts` ผลิตไฟล์ JSON Units 21–25 ครบทั้งใน `src/data/lessons/tier2/` และ `data/lessons/tier2/`
