...
2. **Sensory Feedback:** ทุกสัมผัสมีเสียงดนตรีสดใส (Marimba, Bamboo Woodblock) และมาสคอตน้องกระต่ายทู่ทู่ขยับดุ๊กดิ๊ก
...
| :--- | :--- | :--- |
| **1. 🎢 Tone Mastery** | **Bunny Tone Coaster (รถไฟเหาะผจญภัย 4 เสียง)** | ✅ ออกแบบสมบูรณ์ |
...
## 🎢 Game 01: Bunny Tone Coaster (รถไฟเหาะผจญภัย 4 เสียง)

### 1. 🏷️ ข้อมูลทั่วไป (Game Metadata)
* **ชื่อเกม:** Bunny Tone Coaster: รถไฟเหาะผจญภัย 4 เสียง 🎢🐰
...
* ทู่ทู่ (Tutu) น้องกระต่ายหูตกยืนอยู่บนหัวรถจักร เป่าแคนเสียงพินอิน เช่น ออกเสียง **"mā" (เสียง 1)**
...
* **มาสคอตปลอบใจ:** ทู่ทู่เอียงคอสงสัย 45 องศาแล้วกระพริบตาปริบๆ หูดุ๊กดิ๊ก
* **เสียงบรรยายอบอุ่น:** *"เอ๊ะ รางนี้สูงไปนิดนึงนะคนเก่ง ลองฟังเสียงอีกที ทู่ทู่จะร้องให้ฟังชัดๆ น้า"*
...
* **มาสคอต:** **"ทู่ทู่" (Tutu 🐰)** น้องกระต่ายหูตกในชุดจีนโมเดิร์น
* **เอฟเฟกต์เสียง (SFX):**
