...
* **Unit 0.3:** 4 วรรณยุกต์ (ā, á, ǎ, à) + เสียงเบา + เส้นขีด 提 (ตวัดขึ้น), 点 (จุด) + หมวดนำ 口 (ปาก), 子 (เด็ก) + มินิเกม **Bunny Tone Coaster**  
...
* **Unit 0.6:** 7 กฎทองลำดับขีด & การประกอบร่างเลโก้อักษรจีน (Radical Assembly)  
  * 🏆 **Tier 0 Grand Boss Quest:** "ไขรหัสลับน้องกระต่ายทู่ทู่" — ฟังเสียง ทายวรรณยุกต์ และประกอบร่าง 5 อักษรจีนแรกในชีวิตอย่างถูกต้อง 100% พร้อมก้าวสู่ Tier 1!
